...
- Add physics [`deepinv.physics.UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.html.md#deepinv.physics.UltrasoundPlaneWave) for ultrasound plane-wave imaging, which can simulate and reconstruct raw RF data. (by [Adrien Besson](https://github.com/AdriBesson))
- Add pretrained SwinIR weights for 2x super-resolution ([#1304](https://github.com/deepinv/deepinv/pull/1304) by [Vicky De Ridder](https://github.com/nucli-vicky))
- Add [`deepinv.sampling.PiGDMDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.PiGDMDataFidelity.html.md#deepinv.sampling.PiGDMDataFidelity), [`deepinv.sampling.MomentMatchingDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.MomentMatchingDataFidelity.html.md#deepinv.sampling.MomentMatchingDataFidelity), [`deepinv.sampling.ALDDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ALDDataFidelity.html.md#deepinv.sampling.ALDDataFidelity), [`deepinv.sampling.ScoreSDEDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ScoreSDEDataFidelity.html.md#deepinv.sampling.ScoreSDEDataFidelity) and [`deepinv.sampling.ILVRDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ILVRDataFidelity.html.md#deepinv.sampling.ILVRDataFidelity) noisy data-fidelity terms for diffusion posterior sampling, with a new example `demo_noisy_data_fidelity.py` ([#1279](https://github.com/deepinv/deepinv/pull/1279) by [Samuel Hurault](https://github.com/samuro95))
...
- Add [`deepinv.datasets.CalgarySliceDataset`](https://deepinv.org/api/stubs/deepinv.datasets.CalgarySliceDataset.html.md#deepinv.datasets.CalgarySliceDataset) for raw MRI data from Calgary-Campinas dataset([#1374](https://github.com/deepinv/deepinv/pull/1374) by `Andrew Wang`_`)
- Add [`deepinv.models.DIRECTModel`](https://deepinv.org/api/stubs/deepinv.models.DIRECTModel.html.md#deepinv.models.DIRECTModel) pretrained models for MRI (Joint IC-Net, Recurrent VarNet, vSHARP, XPDNet etc.) ([#1374](https://github.com/deepinv/deepinv/pull/1374) by `Andrew Wang`_`)
- Add [`deepinv.utils.load_ismrmrd_raw()`](https://deepinv.org/api/stubs/deepinv.utils.load_ismrmrd_raw.html.md#deepinv.utils.load_ismrmrd_raw) to load data with `ismrmrd` library ([#1374](https://github.com/deepinv/deepinv/pull/1374) by `Andrew Wang`_`)
- Add [`deepinv.physics.NonCartesianMRI`](https://deepinv.org/api/stubs/deepinv.physics.NonCartesianMRI.html.md#deepinv.physics.NonCartesianMRI) non-Cartesian MRI physics with `mri-nufft` ([#1381](https://github.com/deepinv/deepinv/pull/1381) by `Andrew Wang`_`)
- Add [`deepinv.datasets.DeteCTDataset`](https://deepinv.org/api/stubs/deepinv.datasets.DeteCTDataset.html.md#deepinv.datasets.DeteCTDataset) dataset for real CT sinograms ([#1378](https://github.com/deepinv/deepinv/pull/1378) by `Andrew Wang`_`)
...
- Add [`deepinv.optim.RDP`](https://deepinv.org/api/stubs/deepinv.optim.RDP.html.md#deepinv.optim.RDP) prior ([#1322](https://github.com/deepinv/deepinv/pull/1322) by [Thibaut Modrzyk](https://github.com/Tmodrzyk))
- Add [`deepinv.optim.BSREM`](https://deepinv.org/api/stubs/deepinv.optim.BSREM.html.md#deepinv.optim.BSREM) algorithm for emission tomography and new PET demos ([#1322](https://github.com/deepinv/deepinv/pull/1322) by [Thibaut Modrzyk](https://github.com/Tmodrzyk))
- Add blind Richardson-Lucy algorithm [`deepinv.optim.BlindRL`](https://deepinv.org/api/stubs/deepinv.optim.BlindRL.html.md#deepinv.optim.BlindRL) for blind deconvolution along with a demo ([#988](https://github.com/deepinv/deepinv/pull/988) by [Thibaut Modrzyk](https://github.com/Tmodrzyk))

### Changed

- Remove dependency on timm for SwinIR and SCUNet ([#1304](https://github.com/deepinv/deepinv/pull/1304) by [Vicky De Ridder](https://github.com/nucli-vicky))
- Center the titles above each figure in [`deepinv.utils.plot_ortho3D()`](https://deepinv.org/api/stubs/deepinv.utils.plot_ortho3D.html.md#deepinv.utils.plot_ortho3D) ([#1322](https://github.com/deepinv/deepinv/pull/1322) by [Thibaut Modrzyk](https://github.com/Tmodrzyk))
- Make the implementation of [`deepinv.transform.Shift`](https://deepinv.org/api/stubs/deepinv.transform.Shift.html.md#deepinv.transform.Shift) parallel with respect to the number of transforms ([#1408](https://github.com/deepinv/deepinv/pull/1408) by [Jérémy Scanvic](https://github.com/jscanvic))
...
- Fix global optim step size increased by failed backtracking in [`deepinv.optim.FixedPoint`](https://deepinv.org/api/stubs/deepinv.optim.FixedPoint.html.md#deepinv.optim.FixedPoint) ([#1314](https://github.com/deepinv/deepinv/pull/1314) by [Thibaut Modrzyk](https://github.com/Tmodrzyk))
- Fix incorrect shapes (H, W, D) to match deepinv’s convention (D, H, W) in [`deepinv.datasets.BrainWebPET`](https://deepinv.org/api/stubs/deepinv.datasets.BrainWebPET.html.md#deepinv.datasets.BrainWebPET) and [`deepinv.physics.PET`](https://deepinv.org/api/stubs/deepinv.physics.PET.html.md#deepinv.physics.PET) ([#1322](https://github.com/deepinv/deepinv/pull/1322) by [Thibaut Modrzyk](https://github.com/Tmodrzyk))
