...
```none
Selected GPU 0 with 10539.4375 MiB free memory
```
...
/local/jtachell/deepinv/deepinv/deepinv/physics/tomography.py:186: UserWarning: The default value of `normalize` is not specified and will be automatically set to `True`. Set `normalize` explicitly to `True` or `False` to avoid this warning.
  warn(
/local/jtachell/deepinv/deepinv/deepinv/physics/forward.py:487: DeprecationWarning: Following torch.nn.Module's design, the 'device' attribute is deprecated and will be removed in a future version. To move the module's buffers/parameters to a different device, use the `to()` method.
  warnings.warn(
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=6.436, PSNR no learning=-7.499
Test results:
PSNR no learning: -7.499 +- 0.396
PSNR: 6.436 +- 0.626

{'PSNR no learning': -7.499295902252197, 'PSNR no learning_std': 0.39610846096267105, 'PSNR': 6.436119794845581, 'PSNR_std': 0.6255180853250772, 'runtime': 10.87981742899865, 'peak_gpu_memory_usage': 0.695467472076416}
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=2.948, PSNR no learning=-7.505
Test results:
PSNR no learning: -7.505 +- 0.387
PSNR: 2.948 +- 0.678

{'PSNR no learning': -7.5049192905426025, 'PSNR no learning_std': 0.387037327188003, 'PSNR': 2.9484135627746584, 'PSNR_std': 0.6784892574137888, 'runtime': 4.70627345982939, 'peak_gpu_memory_usage': 0.6954469680786133}
```
...
```none
Eval epoch 0: TotalLoss=0.015, PSNR=0.312, PSNR no learning=-7.527
Test results:
PSNR no learning: -7.527 +- 0.411
PSNR: 0.312 +- 0.526

{'PSNR no learning': -7.526713085174561, 'PSNR no learning_std': 0.41130517999290767, 'PSNR': 0.3118806783109903, 'PSNR_std': 0.5259030128043785, 'runtime': 4.361326837912202, 'peak_gpu_memory_usage': 0.6954379081726074}
```
...
**Total running time of the script:** (0 minutes 39.269 seconds)
