...
```none
Selected GPU 0 with 10540.4375 MiB free memory
```
...
```none
Eval epoch 0: PSNR=29.491, PSNR no learning=27.655
Test results:
PSNR no learning: 27.655 +- 0.003
PSNR: 29.491 +- 0.003
```
...
**Total running time of the script:** (1 minutes 54.559 seconds)
