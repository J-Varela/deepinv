...
```none
Eval epoch 0: TotalLoss=0.003, PSNR=23.2, PSNR no learning=20.059
Test results:
PSNR no learning: 20.059 +- 0.224
PSNR: 23.200 +- 0.638

{'PSNR no learning': 20.058787994384765, 'PSNR no learning_std': 0.2240126492605046, 'PSNR': 23.200223388671876, 'PSNR_std': 0.6377515196992727, 'runtime': 0.34683058224618435, 'peak_gpu_memory_usage': 0.9374833106994629}
```
