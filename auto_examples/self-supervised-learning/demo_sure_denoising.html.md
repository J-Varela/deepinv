...
<a id="sphx-glr-auto-examples-self-supervised-learning-demo-sure-denoising-py"></a>
...
We set [`deepinv.loss.SurePoissonLoss`](https://deepinv.org/api/stubs/deepinv.loss.SurePoissonLoss.html.md#deepinv.loss.SurePoissonLoss) as the training loss.

#### NOTE
There are SURE losses for various noise distributions. See also [`deepinv.loss.SureGaussianLoss`](https://deepinv.org/api/stubs/deepinv.loss.SureGaussianLoss.html.md#deepinv.loss.SureGaussianLoss)
for Gaussian noise and [`deepinv.loss.SurePGLoss`](https://deepinv.org/api/stubs/deepinv.loss.SurePGLoss.html.md#deepinv.loss.SurePGLoss) for mixed Poisson-Gaussian noise.
...
```none
Eval epoch 0: TotalLoss=0.002, PSNR=26.06, PSNR no learning=19.487
Test results:
PSNR no learning: 19.487 +- 1.628
PSNR: 26.060 +- 1.404

{'PSNR no learning': 19.487266845703125, 'PSNR no learning_std': 1.6277921401540443, 'PSNR': 26.05984573364258, 'PSNR_std': 1.404464806763813, 'runtime': 0.32800128078088164, 'peak_gpu_memory_usage': 0.9374828338623047}
```
...
<a id="sphx-glr-download-auto-examples-self-supervised-learning-demo-sure-denoising-py"></a>
