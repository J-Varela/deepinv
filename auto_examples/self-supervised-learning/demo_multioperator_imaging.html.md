...
<a id="sphx-glr-auto-examples-self-supervised-learning-demo-multioperator-imaging-py"></a>
...
This self-supervised learning approach is presented in Tachella *et al.*<sup>[1](#footcite-tachella2022unsupervised)</sup> and minimizes the loss function:
...
If the [`deepinv.datasets.generate_dataset()`](https://deepinv.org/api/stubs/deepinv.datasets.generate_dataset.html.md#deepinv.datasets.generate_dataset) receives a list of physics operators, it
...
Necessary and sufficient conditions on the number of operators and measurements are described in Tachella *et al.*<sup>[2](#footcite-tachella2023sensing)</sup>.
...
<!-- GENERATED FROM PYTHON SOURCE LINES 171-209 -->
```Python
...
```none
Eval epoch 0: MCLoss=0.0, MOILoss=0.0, TotalLoss=0.0, PSNR=14.086, PSNR no learning=13.634
Test results:
PSNR no learning: 13.634 +- 1.998
PSNR: 14.086 +- 2.021

{'PSNR no learning': 13.633685493469239, 'PSNR no learning_std': 1.9978854081703776, 'PSNR': 14.086492919921875, 'PSNR_std': 2.0206539792493223, 'runtime': 0.21265205973759294, 'peak_gpu_memory_usage': 0.807100772857666}
```
...
* <a id='footcite-tachella2023sensing'>**[2]**</a> Julián Tachella, Dongdong Chen, and Mike Davies. Sensing theorems for unsupervised learning in linear inverse problems. *Journal of Machine Learning Research*, 24(39):1–45, 2023. URL: [http://jmlr.org/papers/v24/22-0315.html](http://jmlr.org/papers/v24/22-0315.html).

**Total running time of the script:** (1 minutes 47.272 seconds)

<a id="sphx-glr-download-auto-examples-self-supervised-learning-demo-multioperator-imaging-py"></a>
