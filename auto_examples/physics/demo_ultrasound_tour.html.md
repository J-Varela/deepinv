...
<!-- "auto_examples/physics/demo_ultrasound_tour.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-physics-demo-ultrasound-tour-py"></a>

# Tour of ultrafast ultrasound in DeepInverse

This example presents the plane-wave ultrafast ultrasound forward physics ([`deepinv.physics.UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.html.md#deepinv.physics.UltrasoundPlaneWave)) available in
...
$\pm 12^\circ$. The center frequency of the array is 5 MHz and the speed of sound is 1540 m/s. The region to image is given in meters: 5 to 40 mm deep, 24 mm
...
[`deepinv.physics.UltrasoundPlaneWave`](https://deepinv.org/api/stubs/deepinv.physics.UltrasoundPlaneWave.html.md#deepinv.physics.UltrasoundPlaneWave) gathers the grid to
...
<a id="sphx-glr-download-auto-examples-physics-demo-ultrasound-tour-py"></a>
