...
<a id="sphx-glr-auto-examples-physics-demo-ptychography-py"></a>
...
```none
Selected GPU 0 with 21912.4375 MiB free memory
```
...
```none
Iter 0, loss: tensor([23953.7969])
Iter 10, loss: tensor([14560.8633])
Iter 20, loss: tensor([12004.5977])
Iter 30, loss: tensor([7250.1792])
Iter 40, loss: tensor([5520.6875])
Iter 50, loss: tensor([4522.0405])
Iter 60, loss: tensor([3419.8633])
Iter 70, loss: tensor([3913.1392])
Iter 80, loss: tensor([4161.0859])
Iter 90, loss: tensor([3791.1162])
Iter 100, loss: tensor([3648.5811])
Iter 110, loss: tensor([3786.7334])
Iter 120, loss: tensor([3977.0745])
Iter 130, loss: tensor([4031.7908])
Iter 140, loss: tensor([3594.1548])
Iter 150, loss: tensor([3311.9482])
Iter 160, loss: tensor([3607.7659])
Iter 170, loss: tensor([3034.9663])
Iter 180, loss: tensor([4828.3267])
Iter 190, loss: tensor([3445.6357])
```
...
<a id="sphx-glr-download-auto-examples-physics-demo-ptychography-py"></a>
