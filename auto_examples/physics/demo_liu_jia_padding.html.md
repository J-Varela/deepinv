...
<!-- "auto_examples/physics/demo_liu_jia_padding.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-physics-demo-liu-jia-padding-py"></a>
...
[`Liu-Jia padding`](https://deepinv.org/api/stubs/deepinv.physics.functional.liu_jia_pad.html.md#deepinv.physics.functional.liu_jia_pad) <sup>[1](#footcite-liu2008reducing)</sup>
...
The implementation used here is adapted from [the one](https://github.com/cszn/USRNet)
featured in the work of Zhang *et al.*<sup>[2](#footcite-zhang2020deep)</sup>.
...
```none
Selected GPU 0 with 14428.4375 MiB free memory
```
...
where $X$ is the Fourier transform of the original image, $Y$ is the
Fourier transform of the blurry image, and $H$ is the Fourier transform of
the blur kernel.
...
<a id="sphx-glr-download-auto-examples-physics-demo-liu-jia-padding-py"></a>
