...
Train epoch 0: TotalLoss=0.0, PSNR=30.979
```
...
Eval epoch 0: PSNR=31.005, PSNR no learning=29.991
Test results:
PSNR no learning: 29.991 +- 0.464
PSNR: 31.005 +- 0.718
Eval epoch 0: PSNR=28.879, PSNR no learning=28.03
Test results:
PSNR no learning: 28.030 +- 0.351
PSNR: 28.879 +- 0.327
```
...
Train epoch 0: TotalLoss=0.004, CropPSNR=24.314
```
...
**Total running time of the script:** (0 minutes 13.977 seconds)
