...
<a id="sphx-glr-auto-examples-sampling-demo-diffpir-py"></a>

# Implementing DiffPIR

In this tutorial, we revisit the implementation of the DiffPIR diffusion algorithm for image reconstruction from Zhu *et al.*<sup>[1](#footcite-zhu2023denoising)</sup>.
The full algorithm is implemented in [`deepinv.sampling.DiffPIR`](https://deepinv.org/api/stubs/deepinv.sampling.DiffPIR.html.md#deepinv.sampling.DiffPIR).
...
which for Gaussian Noise (implemented as [`deepinv.optim.data_fidelity.L2`](https://deepinv.org/api/stubs/deepinv.optim.L2.html.md#deepinv.optim.L2)) is given by:
...
Note that other data fidelity terms can be used, such as [`deepinv.optim.PoissonLikelihood`](https://deepinv.org/api/stubs/deepinv.optim.PoissonLikelihood.html.md#deepinv.optim.PoissonLikelihood).
...
of DiffPIR use a U-Net architecture from Ho *et al.*<sup>[2](#footcite-ho2020denoising)</sup>,
...
```none
/local/jtachell/deepinv/deepinv/.pixi/envs/docs/lib/python3.12/site-packages/numpy/_core/fromnumeric.py:45: DeprecationWarning: __array_wrap__ must accept context and return_scalar arguments (positionally) in the future. (Deprecated NumPy 2.0)
  return conv.wrap(result, to_scalar=False)
/local/jtachell/deepinv/deepinv/examples/sampling/demo_diffpir.py:122: UserWarning: To copy construct from a tensor, it is recommended to use sourceTensor.detach().clone() or sourceTensor.detach().clone().requires_grad_(True), rather than torch.tensor(sourceTensor).
  return torch.tensor(alphas_cumprod)
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 322-385 -->
```Python
# Initialization
...
```none
  0%|          | 0/30 [00:00<?, ?it/s]
  7%|▋         | 2/30 [00:00<00:01, 18.93it/s]
 13%|█▎        | 4/30 [00:00<00:01, 19.11it/s]
 20%|██        | 6/30 [00:00<00:01, 19.13it/s]
 27%|██▋       | 8/30 [00:00<00:01, 19.16it/s]
 33%|███▎      | 10/30 [00:00<00:01, 19.19it/s]
 40%|████      | 12/30 [00:00<00:00, 19.21it/s]
 47%|████▋     | 14/30 [00:00<00:00, 19.24it/s]
 53%|█████▎    | 16/30 [00:00<00:00, 19.26it/s]
 60%|██████    | 18/30 [00:00<00:00, 19.30it/s]
 67%|██████▋   | 20/30 [00:01<00:00, 19.35it/s]
 73%|███████▎  | 22/30 [00:01<00:00, 19.34it/s]
 80%|████████  | 24/30 [00:01<00:00, 19.34it/s]
 87%|████████▋ | 26/30 [00:01<00:00, 19.35it/s]
 93%|█████████▎| 28/30 [00:01<00:00, 19.34it/s]
...
<!-- GENERATED FROM PYTHON SOURCE LINES 387-407 -->
```Python
plot(
    list_noisy,
...
You can readily use this algorithm via the [`deepinv.sampling.DiffPIR`](https://deepinv.org/api/stubs/deepinv.sampling.DiffPIR.html.md#deepinv.sampling.DiffPIR) class.
...
* <a id='footcite-ho2020denoising'>**[2]**</a> Jonathan Ho, Ajay Jain, and Pieter Abbeel. Denoising diffusion probabilistic models. *Advances in neural information processing systems*, 33:6840–6851, 2020.

**Total running time of the script:** (0 minutes 11.852 seconds)

🏷 Tags: Diffusion, Deblurring, Denoising

<a id="sphx-glr-download-auto-examples-sampling-demo-diffpir-py"></a>
