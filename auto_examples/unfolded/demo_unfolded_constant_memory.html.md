...
```none
Selected GPU 0 with 16762.4375 MiB free memory
```
...
```none
Full backpropagation: time per iteration: 33.65 s.
Implicit differentiation: time per iteration: 65.95 s.
Full backpropagation: peak memory usage: 4833.9 MB
Implicit differentiation: peak memory usage: 1872.4 MB
Memory reduction factor: 2.6x
```

**Total running time of the script:** (24 minutes 55.060 seconds)
