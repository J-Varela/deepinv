...
<a id="sphx-glr-auto-examples-unfolded-demo-unfolded-constrained-lista-py"></a>
...
```none
Selected GPU 0 with 21513.4375 MiB free memory
```
...
[`deepinv.datasets.generate_dataset()`](https://deepinv.org/api/stubs/deepinv.datasets.generate_dataset.html.md#deepinv.datasets.generate_dataset) function.

Once the dataset is generated, we can load it using the [`deepinv.datasets.HDF5Dataset`](https://deepinv.org/api/stubs/deepinv.datasets.HDF5Dataset.html.md#deepinv.datasets.HDF5Dataset) class.
...
[`deepinv.loss.SupLoss`](https://deepinv.org/api/stubs/deepinv.loss.SupLoss.html.md#deepinv.loss.SupLoss) class.
...
Train epoch 0: TotalLoss=0.02, PSNR=20.93
Train epoch 1: TotalLoss=0.003, PSNR=26.241
Train epoch 2: TotalLoss=0.003, PSNR=26.482
Train epoch 3: TotalLoss=0.003, PSNR=26.624
Train epoch 4: TotalLoss=0.003, PSNR=26.737
Train epoch 5: TotalLoss=0.003, PSNR=26.829
Train epoch 6: TotalLoss=0.003, PSNR=26.909
Train epoch 7: TotalLoss=0.003, PSNR=26.977
Train epoch 8: TotalLoss=0.003, PSNR=27.025
Train epoch 9: TotalLoss=0.003, PSNR=27.031
```
...
```none
Eval epoch 0: PSNR=24.732, PSNR no learning=6.654
Test results:
PSNR no learning: 6.654 +- 0.894
PSNR: 24.732 +- 0.326

{'PSNR no learning': 6.6535491943359375, 'PSNR no learning_std': 0.8941914593348746, 'PSNR': 24.732444763183594, 'PSNR_std': 0.32560929605365696, 'runtime': 0.28869013488292694, 'peak_gpu_memory_usage': 0.6906976699829102}
```
...
**Total running time of the script:** (0 minutes 52.565 seconds)

<a id="sphx-glr-download-auto-examples-unfolded-demo-unfolded-constrained-lista-py"></a>
