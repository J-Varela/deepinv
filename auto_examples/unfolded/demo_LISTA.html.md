...
<a id="sphx-glr-auto-examples-unfolded-demo-lista-py"></a>

# Learned Iterative Soft-Thresholding Algorithm (LISTA) for compressed sensing

This example shows how to implement the LISTA algorithm Gregor and LeCun<sup>[1](#footcite-gregor2010learning)</sup>,
...
In this example, following the original LISTA algorithm Gregor and LeCun<sup>[1](#footcite-gregor2010learning)</sup>
...
The proximal gradient iteration (see also [`deepinv.optim.optim_iterators.PGDIteration`](https://deepinv.org/api/stubs/deepinv.optim.optim_iterators.PGDIteration.html.md#deepinv.optim.optim_iterators.PGDIteration)) is defined as
...
which corresponds to soft-thresholding with a wavelet basis (see [`deepinv.optim.WaveletPrior`](https://deepinv.org/api/stubs/deepinv.optim.WaveletPrior.html.md#deepinv.optim.WaveletPrior)).

We use [`deepinv.optim.PGD()`](https://deepinv.org/api/stubs/deepinv.optim.PGD.html.md#deepinv.optim.PGD)  with `unfold=True` to define the unfolded algorithm
...
Train epoch 0: TotalLoss=0.054, PSNR=12.981
Eval epoch 0: PSNR=14.131
Best model saved at epoch 1
Train epoch 1: TotalLoss=0.052, PSNR=13.131
Eval epoch 1: PSNR=14.266
Best model saved at epoch 2
Train epoch 2: TotalLoss=0.051, PSNR=13.221
Eval epoch 2: PSNR=14.361
Best model saved at epoch 3
Train epoch 3: TotalLoss=0.05, PSNR=13.298
Eval epoch 3: PSNR=14.444
Best model saved at epoch 4
Train epoch 4: TotalLoss=0.05, PSNR=13.329
Eval epoch 4: PSNR=14.444
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 258-279 -->
```Python
...
```none
Eval epoch 0: PSNR=14.444, PSNR no learning=12.59
Test results:
PSNR no learning: 12.590 +- 1.890
PSNR: 14.444 +- 1.727
```
...
* <a id='footcite-gregor2010learning'>**[1]**</a> Karol Gregor and Yann LeCun. Learning fast approximations of sparse coding. In *Proceedings of the 27th international conference on international conference on machine learning*, 399–406. 2010.

**Total running time of the script:** (0 minutes 51.855 seconds)

<a id="sphx-glr-download-auto-examples-unfolded-demo-lista-py"></a>
