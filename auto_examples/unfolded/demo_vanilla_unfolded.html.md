...
```none
Selected GPU 0 with 20135.4375 MiB free memory
```
...
```none
/local/jtachell/deepinv/deepinv/deepinv/datasets/bsds500.py:56: DeprecationWarning: The tuple format for dataset outputs is deprecated and will be removed in a future version.It is recommended to set `use_dict_output=True` for better readability and flexibility in returned outputs.The default is currently `False` for backward compatibility, but will be switched to `True` in a future version.
...
/local/jtachell/deepinv/deepinv/deepinv/training/trainer.py:565: UserWarning: early_stop should be an integer or None. Setting early_stop=3. This behaviour will be deprecated in future versions.
  warnings.warn(
Train epoch 0: TotalLoss=0.003, PSNR=27.909
Eval epoch 0: PSNR=25.154
Best model saved at epoch 1
Train epoch 1: TotalLoss=0.003, PSNR=27.956
Eval epoch 1: PSNR=25.226
Best model saved at epoch 2
Train epoch 2: TotalLoss=0.003, PSNR=27.988
Eval epoch 2: PSNR=25.14
```
...
```none
Eval epoch 0: PSNR=25.14, PSNR no learning=9.123
Test results:
PSNR no learning: 9.123 +- 2.904
PSNR: 25.140 +- 4.097
```

**Total running time of the script:** (0 minutes 55.150 seconds)
