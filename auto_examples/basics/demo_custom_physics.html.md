...
<!-- GENERATED FROM PYTHON SOURCE LINES 63-98 -->
```Python
...
<!-- GENERATED FROM PYTHON SOURCE LINES 207-242 -->
```Python
...
```none
Elapsed time for LinearPhysics: 0.02 seconds
Elapsed time for DecomposablePhysics: 3.83e-03 seconds
```
