...
<!-- "auto_examples/optimization/demo_3D_denoising.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-optimization-demo-3d-denoising-py"></a>
...
<!-- GENERATED FROM PYTHON SOURCE LINES 37-85 -->
```Python
...
```none
Selected GPU 0 with 22493.4375 MiB free memory
...
A convenient algorithm in this situation is the Dykstra-like algorithm proposed by Combettes<sup>[1](#footcite-combettes2009iterative)</sup>, writing
...
<!-- GENERATED FROM PYTHON SOURCE LINES 247-291 -->
```Python
...
You can readily use this algorithm via the [`deepinv.models.WaveletDictDenoiser`](https://deepinv.org/api/stubs/deepinv.models.WaveletDictDenoiser.html.md#deepinv.models.WaveletDictDenoiser) class.
...
* <a id='footcite-combettes2009iterative'>**[1]**</a> Patrick L Combettes. Iterative construction of the resolvent of a sum of maximal monotone operators. *J. Convex Anal*, 16(4):727–748, 2009.

**Total running time of the script:** (0 minutes 9.009 seconds)

🏷 Tags: MRI, Denoising

<a id="sphx-glr-download-auto-examples-optimization-demo-3d-denoising-py"></a>
