...
```none
Selected GPU 0 with 8229.4375 MiB free memory
```
...
/local/jtachell/deepinv/deepinv/deepinv/training/adversarial.py:168: UserWarning: optimizer_step_multi_dataset parameter of Trainer is should be set to `False` when using adversarial trainer. Automatically setting it to `False`.
  warnings.warn(
Train epoch 0: SupLoss=0.005, SupAdversarialGeneratorLoss=0.003, TotalLoss=0.008, PSNR=24.786
Eval epoch 0: PSNR=26.728
...
```none
Eval epoch 0: PSNR=26.728, PSNR no learning=24.985
Test results:
PSNR no learning: 24.985 +- 4.029
PSNR: 26.728 +- 3.311

{'PSNR no learning': 24.98462858200073, 'PSNR no learning_std': 4.028837542782329, 'PSNR': 26.727747631072997, 'PSNR_std': 3.3105314816889764, 'runtime': 0.27574851270765066, 'peak_gpu_memory_usage': 0.7656660079956055}
```
...
```none
The model has 444867 trainable parameters
Train epoch 0: TotalLoss=0.138, PSNR=24.231
Eval epoch 0: PSNR=25.384
Best model saved at epoch 1
```
...
```none
Eval epoch 0: PSNR=25.384, PSNR no learning=24.985
Test results:
PSNR no learning: 24.985 +- 4.029
PSNR: 25.384 +- 2.934

{'PSNR no learning': 24.98462858200073, 'PSNR no learning_std': 4.028837542782329, 'PSNR': 25.383651733398438, 'PSNR_std': 2.9343963315916897, 'runtime': 0.3187389839440584, 'peak_gpu_memory_usage': 0.7646875381469727}
```

<!-- GENERATED FROM PYTHON SOURCE LINES 291-320 -->
...
<!-- GENERATED FROM PYTHON SOURCE LINES 320-338 -->
```Python
...
Train epoch 0: TotalLoss=0.007, PSNR=9.123
```
...
```none
Eval epoch 0: PSNR=9.504, PSNR no learning=24.985
Test results:
PSNR no learning: 24.985 +- 4.029
PSNR: 9.504 +- 1.380

{'PSNR no learning': 24.98462858200073, 'PSNR no learning_std': 4.028837542782329, 'PSNR': 9.503546762466431, 'PSNR_std': 1.3801187636275478, 'runtime': 2.5880398880690336, 'peak_gpu_memory_usage': 0.7589154243469238}
```
...
**Total running time of the script:** (0 minutes 22.923 seconds)

🏷 Tags: Deblurring, GANs
