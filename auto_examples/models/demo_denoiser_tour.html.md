...
```none
/local/jtachell/deepinv/deepinv/examples/models/demo_denoiser_tour.py:81: DeprecationWarning: The function `deepinv.utils.plot_inset` is deprecated and will be removed in a future version. Use `deepinv.utils.plot` with `plot_inset=True` instead, which has the same functionality.
  plot_inset(
...
/local/jtachell/deepinv/deepinv/examples/models/demo_denoiser_tour.py:124: DeprecationWarning: The function `deepinv.utils.plot_inset` is deprecated and will be removed in a future version. Use `deepinv.utils.plot` with `plot_inset=True` instead, which has the same functionality.
  plot_inset(
```
...
```none
Denoiser DRUNet... done (2.22s)
Denoiser SCUNet... done (2.63s)
Denoiser DnCNN... done (0.57s)
Denoiser BM3D... done (46.19s)
Denoiser Wavelet... done (0.68s)
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 316-387 -->
```Python
...
```none
/local/jtachell/deepinv/deepinv/examples/models/demo_denoiser_tour.py:361: DeprecationWarning: The function `deepinv.utils.plot_inset` is deprecated and will be removed in a future version. Use `deepinv.utils.plot` with `plot_inset=True` instead, which has the same functionality.
  plot_inset(
/local/jtachell/deepinv/deepinv/deepinv/utils/plotting.py:462: UserWarning: This figure was using a layout engine that is incompatible with subplots_adjust and/or tight_layout; not calling subplots_adjust.
  fig.subplots_adjust(top=0.75)
/local/jtachell/deepinv/deepinv/examples/models/demo_denoiser_tour.py:377: DeprecationWarning: The function `deepinv.utils.plot_inset` is deprecated and will be removed in a future version. Use `deepinv.utils.plot` with `plot_inset=True` instead, which has the same functionality.
  plot_inset(
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 390-425 -->
```Python
adapted_denoisers = {
...
```none
Denoiser DnCNN (adapted)... done (0.40s)
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 430-447 -->
```Python
...
**Total running time of the script:** (1 minutes 35.985 seconds)
