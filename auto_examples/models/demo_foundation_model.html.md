...
<a id="sphx-glr-auto-examples-models-demo-foundation-model-py"></a>

# Inference and fine-tune a foundation model

This example shows how to perform inference on and fine-tune the Reconstruct Anything Model (RAM) foundation model <sup>[1](#footcite-terris2025reconstruct)</sup> to solve inverse problems.

The [`Reconstruct Anything Model`](https://deepinv.org/api/stubs/deepinv.models.RAM.html.md#deepinv.models.RAM) is a model that has been trained to work on a large
...
```none
Selected GPU 0 with 21600.4375 MiB free memory
```
...
<!-- GENERATED FROM PYTHON SOURCE LINES 192-221 -->
```Python
...
**even in the absence of ground truth data**, using a [self-supervised loss](https://deepinv.org/user_guide/training/loss.html.md#self-supervised-losses),
...
#### NOTE
You can also fine-tune on larger datasets if you want, by replacing the [dataset](https://deepinv.org/user_guide/training/datasets.html.md#datasets).
...
<!-- GENERATED FROM PYTHON SOURCE LINES 255-286 -->
```Python
...
Eval epoch 0: R2RLoss=0.151, EILoss=0.001, TotalLoss=0.151
Best model saved at epoch 1
Train epoch 1: R2RLoss=0.127, EILoss=0.0, TotalLoss=0.127
Train epoch 2: R2RLoss=0.119, EILoss=0.0, TotalLoss=0.119
Train epoch 3: R2RLoss=0.12, EILoss=0.0, TotalLoss=0.121
Train epoch 4: R2RLoss=0.121, EILoss=0.0, TotalLoss=0.121
Train epoch 5: R2RLoss=0.128, EILoss=0.0, TotalLoss=0.129
Eval epoch 5: R2RLoss=0.153, EILoss=0.001, TotalLoss=0.153
Train epoch 6: R2RLoss=0.124, EILoss=0.0, TotalLoss=0.124
Train epoch 7: R2RLoss=0.125, EILoss=0.0, TotalLoss=0.126
Train epoch 8: R2RLoss=0.121, EILoss=0.0, TotalLoss=0.122
Train epoch 9: R2RLoss=0.125, EILoss=0.0, TotalLoss=0.125
Train epoch 10: R2RLoss=0.122, EILoss=0.0, TotalLoss=0.123
Eval epoch 10: R2RLoss=0.148, EILoss=0.001, TotalLoss=0.149
Best model saved at epoch 11
Train epoch 11: R2RLoss=0.124, EILoss=0.0, TotalLoss=0.124
Train epoch 12: R2RLoss=0.128, EILoss=0.0, TotalLoss=0.128
Train epoch 13: R2RLoss=0.121, EILoss=0.0, TotalLoss=0.121
Train epoch 14: R2RLoss=0.122, EILoss=0.0, TotalLoss=0.122
Train epoch 15: R2RLoss=0.12, EILoss=0.0, TotalLoss=0.12
Eval epoch 15: R2RLoss=0.158, EILoss=0.001, TotalLoss=0.158
Train epoch 16: R2RLoss=0.122, EILoss=0.0, TotalLoss=0.123
Train epoch 17: R2RLoss=0.125, EILoss=0.0, TotalLoss=0.125
Train epoch 18: R2RLoss=0.12, EILoss=0.0, TotalLoss=0.12
Train epoch 19: R2RLoss=0.127, EILoss=0.0, TotalLoss=0.127
Eval epoch 19: R2RLoss=0.153, EILoss=0.001, TotalLoss=0.153
Model, optimizer, epoch_start successfully loaded from checkpoint: 26-09-21-09:56:37/ckp_best.pth.tar
```
...
**Total running time of the script:** (0 minutes 27.415 seconds)

🏷 Tags: MRI, Tomography, Foundation model

<a id="sphx-glr-download-auto-examples-models-demo-foundation-model-py"></a>
