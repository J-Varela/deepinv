...
<a id="sphx-glr-auto-examples-distributed-demo-physics-distributed-py"></a>
...
This example demonstrates how to use [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.html.md#deepinv.distributed.distribute) to distribute stacked physics
...
2. Stack them using [`deepinv.physics.stack()`](https://deepinv.org/api/stubs/deepinv.physics.stack.html.md#deepinv.physics.stack)
3. Initialize distributed context
4. Distribute physics with [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.html.md#deepinv.distributed.distribute)
...
Running on 1 process(es)
   Device: cuda:0
/local/jtachell/deepinv/deepinv/examples/distributed/demo_physics_distributed.py:92: DeprecationWarning: Function 'gaussian_blur' is deprecated since 0.4.1. Use 'deepinv.physics.functional.blur.gaussian_blur' instead.
  gaussian_blur(sigma=1.0, device=str(device)),  # Small blur
/local/jtachell/deepinv/deepinv/examples/distributed/demo_physics_distributed.py:93: DeprecationWarning: Function 'gaussian_blur' is deprecated since 0.4.1. Use 'deepinv.physics.functional.blur.gaussian_blur' instead.
  gaussian_blur(sigma=2.5, device=str(device)),  # Medium blur
/local/jtachell/deepinv/deepinv/examples/distributed/demo_physics_distributed.py:94: DeprecationWarning: Function 'gaussian_blur' is deprecated since 0.4.1. Use 'deepinv.physics.functional.blur.gaussian_blur' instead.
  gaussian_blur(
...
<a id="sphx-glr-download-auto-examples-distributed-demo-physics-distributed-py"></a>
