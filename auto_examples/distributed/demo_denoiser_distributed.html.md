...
<!-- "auto_examples/distributed/demo_denoiser_distributed.py" -->
<!-- LINE NUMBERS ARE GIVEN BELOW. -->

<a id="sphx-glr-auto-examples-distributed-demo-denoiser-distributed-py"></a>
...
This example demonstrates how to use the [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.html.md#deepinv.distributed.distribute) function to create a
...
5. Distribute denoiser with [`deepinv.distributed.distribute()`](https://deepinv.org/api/stubs/deepinv.distributed.distribute.html.md#deepinv.distributed.distribute)
...
<!-- GENERATED FROM PYTHON SOURCE LINES 110-259 -->
```Python
...
Comparing with non-distributed denoising...
   Mean absolute difference: 6.21e-04
   Max absolute difference:  1.05e-01
   Results are very close (within tolerance)!

Results:
   Input PSNR:  20.33 dB
   Output PSNR: 33.99 dB
   Improvement: 13.66 dB
...
🏷 Tags: Denoising, Distributed

<a id="sphx-glr-download-auto-examples-distributed-demo-denoiser-distributed-py"></a>
