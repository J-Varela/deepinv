...
<a id="sphx-glr-auto-examples-plug-and-play-demo-vanilla-pnp-py"></a>
...
We use the [`deepinv.physics.Tomography`](https://deepinv.org/api/stubs/deepinv.physics.Tomography.html.md#deepinv.physics.Tomography)
...
The denoising step is performed by a DNCNN pretrained denoiser [`deepinv.models.DnCNN`](https://deepinv.org/api/stubs/deepinv.models.DnCNN.html.md#deepinv.models.DnCNN).
...
```none
Linear reconstruction PSNR: 14.37 dB
PnP reconstruction PSNR: 28.16 dB
```
...
<a id="sphx-glr-download-auto-examples-plug-and-play-demo-vanilla-pnp-py"></a>
