...
```none
Selected GPU 0 with 20832.4375 MiB free memory
...
the denoising step is performed by a pretrained denoiser [`deepinv.models.DRUNet`](https://deepinv.org/api/stubs/deepinv.models.DRUNet.html.md#deepinv.models.DRUNet).

#### NOTE
We provide a wrapper for rapidly creating the DPIR algorithm in [`deepinv.optim.DPIR`](https://deepinv.org/api/stubs/deepinv.optim.DPIR.html.md#deepinv.optim.DPIR).
...
Test:   0%|          | 0/1 [00:00<?, ?it/s, PSNR=29.5, PSNR no learning=16.3, LPIPS=0.0409, LPIPS no learning=0.547]
Test: 100%|██████████| 1/1 [00:01<00:00,  1.21s/it, PSNR=29.5, PSNR no learning=16.3, LPIPS=0.0409, LPIPS no learning=0.547]
Test: 100%|██████████| 1/1 [00:01<00:00,  1.21s/it, PSNR=29.5, PSNR no learning=16.3, LPIPS=0.0409, LPIPS no learning=0.547]
Test results:
PSNR no learning: 16.294 +- 1.121
PSNR: 29.465 +- 0.592
LPIPS no learning: 0.547 +- 0.103
LPIPS: 0.041 +- 0.020

{'PSNR no learning': 16.294039408365887, 'PSNR no learning_std': 1.1207271894170592, 'PSNR': 29.46471913655599, 'PSNR_std': 0.5919688465871275, 'LPIPS no learning': 0.5466187795003256, 'LPIPS no learning_std': 0.10261563746371688, 'LPIPS': 0.04090596238772074, 'LPIPS_std': 0.019738823923847466, 'runtime': 1.2144781877286732, 'peak_gpu_memory_usage': 0.9043083190917969}
```
...
**Total running time of the script:** (0 minutes 8.475 seconds)
