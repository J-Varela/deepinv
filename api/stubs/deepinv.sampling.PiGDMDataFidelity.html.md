...
This corresponds to the $p(y|x_t)$ approximation proposed in [[152](https://deepinv.org/user_guide/other/biblio.html.md#id150)].
...
exactly for [`deepinv.physics.DecomposablePhysics`](https://deepinv.org/api/stubs/deepinv.physics.DecomposablePhysics.html.md#deepinv.physics.DecomposablePhysics) operators and
