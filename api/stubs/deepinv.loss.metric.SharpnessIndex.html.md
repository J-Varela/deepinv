...
The metric is used to introduced by Blanchet and Moisan [[14](https://deepinv.org/user_guide/other/biblio.html.md#id102)].
We use the fast implementation presented by Leclaire and Moisan [[88](https://deepinv.org/user_guide/other/biblio.html.md#id101)].
...
specific images that are naturally periodic or not quantized (see Leclaire and Moisan [[88](https://deepinv.org/user_guide/other/biblio.html.md#id101)]).
