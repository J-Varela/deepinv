...
Computes least squares solution to the MRI inverse problem, as proposed in Pruessmann *et al.*<sup>[1](#footcite-pruessmann1999sense)</sup>.
...
* <a id='footcite-pruessmann1999sense'>**[1]**</a> Klaas Pruessmann, Markus Weiger, Markus Scheidegger, and Peter Boesiger. Sense: sensitivity encoding for fast mri. *Magnetic Resonance in Medicine*, 1999. [doi:10.1002/(SICI)1522-2594(199911)42:5%3C952::AID-MRM16%3E3.0.CO;2-S](https://doi.org/10.1002/(SICI)1522-2594(199911)42:5%3C952::AID-MRM16%3E3.0.CO;2-S).
...
This was proposed in Uecker *et al.*<sup>[2](#footcite-uecker2013espirit)</sup>.
...
#### phase_correct_maps(x, smooth=0.05)

Re-gauge coil maps to the smooth phase of some reasonably smooth-phased image.

Learn more about this phase freedom in Uecker and Lustig<sup>[3](#footcite-uecker2017absolute)</sup>.

* **Parameters:**
  * **x** ([*torch.Tensor*](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)) – some image with smooth phase maps e.g. `physics.A_adjoint(y)`.
  * **smooth** ([*float*](https://docs.python.org/3.9/library/functions.html#float)) – low-pass width applied to x phase as a fraction of image size. Larger keeps only smoother phase.
* **Returns:**
  updated coil maps.
...
* <a id='footcite-uecker2017absolute'>**[3]**</a> Martin Uecker and Michael Lustig. Estimating absolute-phase maps using espirit and virtual conjugate coils. *Magnetic Resonance in Medicine*, March 2017. [doi:10.1002/mrm.26191](https://doi.org/10.1002/mrm.26191).
