...
* **Parameters:**
  ...
  * **guidance** ([*str*](https://docs.python.org/3.9/library/stdtypes.html#str)) – the form of the guidance, passed to [`deepinv.sampling.DPSDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.DPSDataFidelity.html.md#deepinv.sampling.DPSDataFidelity).
