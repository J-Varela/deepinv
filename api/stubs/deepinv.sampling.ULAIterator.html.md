...
The algorithm, introduced by Laumont *et al.* [[84](https://deepinv.org/user_guide/other/biblio.html.md#id63)] runs the following markov chain iteration
(Algorithm 2 from [[84](https://deepinv.org/user_guide/other/biblio.html.md#id63)]):
