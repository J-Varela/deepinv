...
- `'aesthetic'` (default), trained on the AVA dataset [[116](https://deepinv.org/user_guide/other/biblio.html.md#id156)], which rates the aesthetic appeal of an image;
- `'technical'`, trained on the TID2013 dataset [[127](https://deepinv.org/user_guide/other/biblio.html.md#id155)], which rates the amount of distortion in an image
