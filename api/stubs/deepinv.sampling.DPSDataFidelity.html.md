...
This corresponds to the $p(y|x_t)$ approximation proposed in [[29](https://deepinv.org/user_guide/other/biblio.html.md#id65)].
...
`guidance="norm"` (the default) follows [[29](https://deepinv.org/user_guide/other/biblio.html.md#id65)] and normalizes
...
[`deepinv.sampling.ALDDataFidelity`](https://deepinv.org/api/stubs/deepinv.sampling.ALDDataFidelity.html.md#deepinv.sampling.ALDDataFidelity), so $\lambda\approx 1$ is the
...
found in [`deepinv.sampling.DPS`](https://deepinv.org/api/stubs/deepinv.sampling.DPS.html.md#deepinv.sampling.DPS).
...
* **Parameters:**
  ...
  * **guidance** ([*str*](https://docs.python.org/3.9/library/stdtypes.html#str)) – Either `"norm"` (default), the residual norm of
    [[29](https://deepinv.org/user_guide/other/biblio.html.md#id65)], or `"annealed"`, the Gaussian negative
